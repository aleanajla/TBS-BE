...
const {addSTID, viewDriver, viewTruck, searchSTID, searchDriver, searchTruck, deleteSTID, viewSTID, editSTID, viewSTIDBooking} = require('../controllers/STIDController')
...
router.get('/users/view/stid/booking/:id', viewSTIDBooking)
